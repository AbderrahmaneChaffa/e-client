            ...
            <tbody class="text-sm">
                ...
                <tr class="hover:bg-gray-50 transition border-b">
                    ...
                    <td class="p-4 border-b text-center">
                        ...
                        <a href="{{ route('client.invoices.facture.print', $facture->id) }}" target="_blank" class="text-gray-400 hover:text-green-600 mx-1 transition-colors" title="Imprimer la facture">

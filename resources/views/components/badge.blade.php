...
@php
    ...
    $map = [
        ...
        'completed' => ['label' => 'Terminé', 'class' => 'bg-success-50 text-success-700 ring-success-600/20 dark:bg-success-900/30 dark:text-success-300', 'icon' => 'check-circle-2'],
        'failed' => ['label' => 'Échec', 'class' => 'bg-danger-50 text-danger-700 ring-danger-600/20 dark:bg-danger-900/30 dark:text-danger-300', 'icon' => 'x-circle'],
        'cancelled' => ['label' => 'Annulé', 'class' => 'bg-danger-50 text-danger-700 ring-danger-600/20 dark:bg-danger-900/30 dark:text-danger-300', 'icon' => 'ban'],
        'annulee' => ['label' => 'Annulée', 'class' => 'bg-danger-50 text-danger-700 ring-danger-600/20 dark:bg-danger-900/30 dark:text-danger-300', 'icon' => 'ban'],
        'paye' => ['label' => 'Payée', 'class' => 'bg-success-50 text-success-700 ring-success-600/20 dark:bg-success-900/30 dark:text-success-300', 'icon' => 'check-circle-2'],
        'payee' => ['label' => 'Payée', 'class' => 'bg-success-50 text-success-700 ring-success-600/20 dark:bg-success-900/30 dark:text-success-300', 'icon' => 'check-circle-2'],
        'impaye' => ['label' => 'Impayée', 'class' => 'bg-danger-50 text-danger-700 ring-danger-600/20 dark:bg-danger-900/30 dark:text-danger-300', 'icon' => 'alert-circle'],
        'impayee' => ['label' => 'Impayée', 'class' => 'bg-danger-50 text-danger-700 ring-danger-600/20 dark:bg-danger-900/30 dark:text-danger-300', 'icon' => 'alert-circle'],
        'en_retard' => ['label' => 'En retard', 'class' => 'bg-danger-50 text-danger-700 ring-danger-600/20 dark:bg-danger-900/30 dark:text-danger-300', 'icon' => 'alert-circle'],
        'en_attente' => ['label' => 'En attente', 'class' => 'bg-warning-50 text-warning-700 ring-warning-600/20 dark:bg-warning-900/30 dark:text-warning-300', 'icon' => 'clock-3'],
        'regle' => ['label' => 'Réglé', 'class' => 'bg-success-50 text-success-700 ring-success-600/20 dark:bg-success-900/30 dark:text-success-300', 'icon' => 'check-circle-2'],
        'warning' => ['label' => 'À vérifier', 'class' => 'bg-warning-50 text-warning-700 ring-warning-600/20 dark:bg-warning-900/30 dark:text-warning-300', 'icon' => 'triangle-alert'],
        ...
        'modified' => ['label' => 'Modifié', 'class' => 'bg-warning-50 text-warning-700 ring-warning-600/20 dark:bg-warning-900/30 dark:text-warning-300', 'icon' => 'pencil'],
